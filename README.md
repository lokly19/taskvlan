...
Mon Mar 18 09:30:17 PM UTC 2024: PING 10.10.10.1 (10.10.10.1) 56(84) bytes of data.
Mon Mar 18 09:30:17 PM UTC 2024: 64 bytes from 10.10.10.1: icmp_seq=1 ttl=64 time=0.972 ms
Mon Mar 18 09:30:18 PM UTC 2024: 64 bytes from 10.10.10.1: icmp_seq=2 ttl=64 time=1.26 ms
Mon Mar 18 09:30:19 PM UTC 2024: 64 bytes from 10.10.10.1: icmp_seq=3 ttl=64 time=1.42 ms
...
Пингуем centralRouter с inetRouter и отключать интерфейсы на officeRouter.

```bash
vagrant@inetRouter:~$ ping -i 4 192.168.255.2 | while read pong; do echo "$(date): $pong"; done
Mon Mar 18 09:38:48 PM UTC 2024: PING 192.168.255.2 (192.168.255.2) 56(84) bytes of data.
Mon Mar 18 09:38:48 PM UTC 2024: 64 bytes from 192.168.255.2: icmp_seq=1 ttl=64 time=1.19 ms
Mon Mar 18 09:38:52 PM UTC 2024: 64 bytes from 192.168.255.2: icmp_seq=2 ttl=64 time=1.19 ms
# выключили enp0s9 на centralRouter (пинги еще идут)
Mon Mar 18 09:38:56 PM UTC 2024: 64 bytes from 192.168.255.2: icmp_seq=3 ttl=64 time=1.38 ms
# выключили enp0s8 на centralRouter (пинги не идут)
Mon Mar 18 09:39:32 PM UTC 2024: From 192.168.255.1 icmp_seq=11 Destination Host Unreachable
Mon Mar 18 09:39:36 PM UTC 2024: From 192.168.255.1 icmp_seq=12 Destination Host Unreachable
# подняли enp0s9 на centralRouter (пинги пошли)
Mon Mar 18 09:39:37 PM UTC 2024: 64 bytes from 192.168.255.2: icmp_seq=13 ttl=64 time=771 ms
Mon Mar 18 09:39:41 PM UTC 2024: 64 bytes from 192.168.255.2: icmp_seq=14 ttl=64 time=1.45 ms
```


```bash
root@centralRouter:~# ip link set enp0s9 down && date
Mon Mar 18 09:38:53 PM UTC 2024

root@centralRouter:~# ip link set enp0s8 down && date
Mon Mar 18 09:38:59 PM UTC 2024

root@centralRouter:~# ip link set enp0s9 up && date
Mon Mar 18 09:39:37 PM UTC 2024
```
